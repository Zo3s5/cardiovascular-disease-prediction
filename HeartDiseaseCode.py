...
# metric scores 
accuracy_2 = [0.83, 0.76, 0.90, 0.71, 0.90, 0.72, 0.89, 0.72, 0.90, 0.77]
precision_2 = [0.23, 0.18, 0.53, 0.22, 0.51, 0.21, 0.40, 0.24, 0.73, 0.61]
recall_2 = [0.28, 0.37, 0.13, 0.73, 0.12, 0.66, 0.12, 0.80, 0.52, 0.71]
f1_score_2 = [0.25, 0.24, 0.20, 0.33, 0.20, 0.32, 0.17, 0.36, 0.52, 0.62]
AUC_2 = [0.58, 0.59, 0.56, 0.72, 0.55, 0.69, 0.54, 0.75, 0.52, 0.71]
